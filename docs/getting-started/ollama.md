...
本文档介绍如何在 Ollama 中使�?MoziAI-35B 模型�?
...
�?[Ollama 官网](https://ollama.com/) 下载并安装�?
...
> 注：Ollama �?TEMPLATE 为示例，推荐使用模型自带�?jinja 模板以获得最佳效果�?
...
| 显存 | 推荐 num_ctx | 说明 |
|------|-------------|------|
| 16 GB | 32768 (32K) | 纯文本推�?|
| 20 GB | 65536 (64K) | 可尝试视�?|
| 24 GB | 131072 (128K) | 视觉+中长上下�?|
...
- 多模态和工具调用功能�?Ollama 中可能有限制
- 如需完整功能（视觉、工具调用、推理链等），推荐使�?llama.cpp
