...
# moziAI-35B-V3.6-A3B-MOE-MTP-Uncensored - Een klein maar krachtig multimodaal AI-model voor gratis lokale implementatie
...
- **Visueel bestand**: `mmproj/35B/moziAI-35B-mmproj-BF16-V1.0.gguf` (ongeveer 903 MB, BF16-precisie)
...
├── moziAI-35B-mmproj-BF16-V1.0.gguf  # Visuele projectie (optioneel, downloaden indien nodig)
...
> Als u beeldmogelijkheden nodig heeft, voeg dan `--mmproj mmproj/35B/moziAI-35B-mmproj-BF16-V1.0.gguf` toe.
...
│   ├── moziAI-35B-mmproj-BF16-V1.0.gguf # Visuele projectie
...
<tr>
<td>Basismodel</td>
<td>Ornith-1.0-35B-A3B (Qwen3.5-35B-A3B / Qwen3.6-35B-A3B architectuur, MIT + Apache-2.0 (Qwen3.5/3.6 & Gemma 4 components)-licentie)</td>
</tr>
<tr>
...
moziAI-35B-V3.6 is gebaseerd op het **Ornith-1.0-35B** (ornith-ai) basismodel en is verfijnd. Voortbouwend op de uitstekende agent-coderingsmogelijkheden van het basismodel, heeft MoziAI een **diepe optimalisatie op financieel gebied** toegevoegd en presteert het beter in scenario's zoals financiële Q&A, kwantitatieve programmering en tool-aanroepen. De algemene mogelijkheden komen overeen met die van het Ornith-1.0-35B basismodel.
