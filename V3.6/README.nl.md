...
# MoziAI-35B-A3B-MOE - Financieel Vertaaldomein LLM - V3.6

[中文](README.md) | [English](README.en.md) | [日本語](README.ja.md) | [한국어](README.ko.md) | [Deutsch](README.de.md) | [Français](README.fr.md) | [Русский](README.ru.md) | [हिन्दी](README.hi.md) | [繁體中文](README.zh-hant.md) | Nederlands | [Italiano](README.it.md)

## Modeloverzicht

MoziAI-35B-A3B-MOE is een lokaal open-source financieel AI multimodaal LLM (ondersteunt visie en tool calling) ontwikkeld door het team van de Chinese financiële invloedspersoon Chen Yumo, fijn-afgestemd/gedistilleerd vanuit het Ornith-1.0-35B (**Qwen3.5-35B-A3B / Qwen3.6-35B-A3B** architectuur, MIT-licentie) basismodel. Door middel van de zelf ontwikkelde **MoziSmartBit Intelligente Kwantisatie**-techniek wordt het 35B-parameter MoE-model gecomprimeerd tot ongeveer **15,5 GB**, waarbij een optimaal evenwicht tussen precisie en grootte wordt bereikt met verliesvrije ~99% precisiekwaliteit.
...
> 💡 **Downloadtip**: Klik op de bovenstaande link naar de HuggingFace-repository, ga vervolgens naar het tabblad **"Files and versions"** om alle bestanden onder de V3.6-map te downloaden (hoofdmodel, visieprojectie, chatsjabloon). Zorg ervoor dat alle drie de bestanden in dezelfde map worden geplaatst.
...
Download alle bestanden onder de V3.6-map van HuggingFace / ModelScope:
...
└── moziAI-V3.6-35B-chat-template.jinja                  # Chatsjabloon (aanbevolen)
```
...
> Voeg `--mmproj V3.6/moziAI-V3.6-35B-uncensored-heretic-mmproj-BF16.gguf` toe voor visiemogelijkheden.
...
│   └── moziAI-V3.6-35B-chat-template.jinja   # Chatsjabloon
```
