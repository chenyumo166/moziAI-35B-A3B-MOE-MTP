...
[中文](README.md) | [English](README.en.md) | [日本語](README.ja.md) | [한국어](README.ko.md) | [Deutsch](README.de.md) | [Français](README.fr.md) | [Русский](README.ru.md) | [हिन्दी](README.hi.md) | 繁體中文 | [Nederlands](README.nl.md) | [Italiano](README.it.md)

## 模型簡介

MoziAI-35B-A3B-MOE 是由中國財經大V陳雨墨團隊開發的本地開源多模態AI大模型（強化金融領域、支持視覺、工具調用、消費級顯卡本地部署），基於 Ornith-1.0-35B（**Qwen3.5-35B-A3B / Qwen3.6-35B-A3B** 架構）底座進行二次開發/微調/蒸餾。透過自研的 **MoziSmartBit 智能量化** 技術，將 350 億參數 MoE 模型壓縮至約 **15.5 GB**，在精度與體積間取得最優平衡，實現幾乎≈FP16的99%的精度質量。
