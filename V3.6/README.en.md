...
# moziAI-13.7-35B-A3B-A3B-MOE-MTP-Uncensored - Free Locally Deployable Small Yet Powerful Multimodal AI Model
...
MoziAI-35B-A3B-MOE is a local open-source multimodal AI large model developed by the team of Chinese financial influencer Chen Yumo. It is enhanced for the financial domain, supports vision, tool calling, and complex long-task capabilities, and can be deployed locally on consumer-grade graphics cards. It is built on top of the Ornith-1.0-35B-A3B base model (**Qwen3.5-35B-A3B/Qwen3.6-35B-A3B** architecture) through further fine-tuning and distillation.
