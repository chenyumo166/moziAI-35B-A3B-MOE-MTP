...
- **Fichier visuel** : `mmproj/35B/moziAI-35B-mmproj-BF16-V1.0.gguf` (environ 903 Mo, précision BF16)
...
├── moziAI-35B-mmproj-BF16-V1.0.gguf  # Projection visuelle (optionnel, télécharger si nécessaire)
...
> Si vous avez besoin de capacités visuelles, ajoutez `--mmproj mmproj/35B/moziAI-35B-mmproj-BF16-V1.0.gguf`
...
│   ├── moziAI-35B-mmproj-BF16-V1.0.gguf # Projection visuelle
...
<td>Ornith-1.0-35B-A3B (architecture Qwen3.5-35B-A3B / Qwen3.6-35B-A3B, licence MIT + Apache-2.0 (Qwen3.5/3.6 & Gemma 4 components))</td>
</tr>
<tr>
...
moziAI-35B-V3.6 est affiné à partir du modèle de base **Ornith-1.0-35B** (ornith-ai). S'appuyant sur les excellentes capacités de codage d'agent du modèle de base, MoziAI a ajouté une **optimisation approfondie du domaine financier**, offrant de meilleures performances dans des scénarios tels que les questions-réponses financières, la programmation quantitative et les appels d'outils. Les capacités générales sont identiques à celles du modèle de base Ornith-1.0-35B.
