...
汎用AI大モデルの能力を維持することに加えて、本モデルは以下を強化しています：金融垂直領域アプリケーション、金融Q&A、定量プログラミング、ツール呼び出し、汎用プログラミングに加え、モデルの七次元思考能力、LOOPメカニズム、様々なエージェントプラットフォームとの互換性。
...
MoziAIは**ornith-ai/Ornith-1.5-35B-A3B**からファインチューニングされています。MoziAIはベースモデルの上で金融垂直ドメインの最適化が施されており、金融Q&A、クオンツプログラミング、tool callingシナリオにおいて優れた性能を発揮します。MoziAI-35Bの汎用能力はOrnith-1.5-35B-A3Bベースモデルと一致しています。
