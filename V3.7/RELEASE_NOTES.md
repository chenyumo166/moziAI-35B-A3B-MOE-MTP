...
- **MoziSmartBit 智能量化算法（Q4_K_M）**：从三值量化升级为 MoziSmartBit 智能量化（Q4_K_M），专家层 Q4_K_M 均匀量化 + MoziSmartBit 智能比特分配，精度 ~99%，模型体积 ~15.5 GB
...
| 项目 | 规格 |
|------|------|
| 底座模型 | Ornith-1.5-35B（Qwen3.5-35B-A3B / Qwen3.6-35B-A3B，MIT 许可） |
| 总参数量 | 35B |
...
*详细评测数据请参阅 [Evaluation Report](../docs/evaluation.md)*
