...
MoziAI-35B-A3B-MOE è un LLM multimodale finanziario AI open-source locale (supporta vision e tool calling) sviluppato dal team dell'influencer finanziario cinese Chen Yumo. moziAI-35B è basato sul modello base open-source Ornith-1.5-35B-A3B (architettura Qwen3.5-35B-A3B / Qwen3.6-35B-A3B, licenza MIT + Apache-2.0 (Qwen3.5/3.6 & Gemma 4 components)), integrando lo sviluppo autonomo del team Chen Yumo: (dati finanziari + capacità del dominio finanziario + metodi di addestramento + framework di pensiero a sette dimensioni + meccanismo LOOP dell'agente + algoritmo di quantizzazione ibrido MoziSmartBit). Attraverso la tecnologia di quantizzazione intelligente MoziSmartBit sviluppata internamente, il modello MoE da 35 miliardi di parametri viene compresso a circa 15,5 GB, ovvero 6,5 GB (circa 30%) in meno rispetto ai modelli di quantizzazione Q4_K_M convenzionali di circa 22+ GB; raggiungendo l'equilibrio ottimale tra precisione e dimensioni, con qualità di precisione quasi senza perdite di circa il 99% della FP16.



Oltre a mantenere le capacità generali dell'IA, questo modello migliora: applicazioni verticali del dominio finanziario, Q&A finanziario, programmazione quantitativa, tool calling e programmazione generale, oltre alla capacità di pensiero a sette dimensioni del modello, al meccanismo LOOP e alla compatibilità con varie piattaforme agent.
...
| Elemento | Specifica |
|----------|-----------|
| Modello Base | Ornith-1.5-35B-A3B (**Qwen3.5-35B-A3B / Qwen3.6-35B-A3B**, licenza MIT + Apache-2.0 (Qwen3.5/3.6 & Gemma 4 components)) |
