...
- [6. Быстрый старт](#6-быстрый-старт-3-файла-100-оптимальный-инференс) — **Комплект из 3 файлов**
...
- [11. Спекулятивное декодирование](#11-спекулятивное-декодирование-ключевая-функция)
- [12. Рекомендации по VRAM](#12-рекомендации-по-vram)
- [13. Методы развертывания](#13-методы-развертывания)
- [14. Бенчмарки](#14-бенчмарки)
- [15. Оптимизация Uncensored](#15-оптимизация-uncensored)
...
Без ограничений контента, свободный вывод, полная информация, локальная приватность (см. [Раздел 15](#15-оптимизация-uncensored)).
...
| --- | --- |
| Базовая модель | Ornith-1.5-35B-A3B (Qwen3.5-35B-A3B / Qwen3.6-35B-A3B, MIT + Apache-2.0 (Qwen3.5/3.6 & Gemma 4 components)) |
...
| context\_length | 131072 | 262144 | Повседневно 128K / Сложно 256K (по умолчанию llama.cpp 128K) |
...
MoziAI-35B-V3.8 доработана/дистиллирована на основе ornith-ai/Ornith-1.5-35B-A3B. Данные из измерений V3.7 (V3.8 = та же база и система обучения):
