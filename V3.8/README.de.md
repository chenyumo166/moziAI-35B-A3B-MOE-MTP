...
[English](README.en.md) | [简体中文](README.zh.md) | [繁體中文](README.zh-hant.md) | [日本語](README.ja.md) | [한국어](README.ko.md) | [हिन्दी](README.hi.md) | Deutsch | [Français](README.fr.md) | [Nederlands](README.nl.md) | [Italiano](README.it.md) | [Русский](README.ru.md) | [Español](README.es.md) | [Português](README.pt.md) | [العربية](README.ar.md) | [Bahasa Indonesia](README.id.md) | [Türkçe](README.tr.md) | [Tiếng Việt](README.vi.md) | [Polski](README.pl.md)
...
MoziAI-35B-V3.8 ist ein lokal bereitstellbares Open-Source-Multimodal-KI-Modell, entwickelt vom Team des chinesischen Finanz-Influencers Chen Yumo. Basierend auf dem Open-Source-Fundament **Ornith-1.5-35B-A3B** (Qwen3.5-35B-A3B / Qwen3.6-35B-A3B-Architektur, MoE 35B, MIT + Apache-2.0 (Qwen3.5/3.6 & Gemma 4 components)-Lizenz) integriert es die selbst entwickelten Finanzdaten + Finanzbereichsfähigkeiten + dynamisches 7-dimensionales Denkframework + Agent-LOOP-Reflexionsmechanismus + Uncensored-Eigenschaft + MoziSmartBit-Hybridquantisierungsalgorithmus.
...
| Punkt | Spezifikation |
| --- | --- |
| Basismodell | Ornith-1.5-35B-A3B (Qwen3.5-35B-A3B / Qwen3.6-35B-A3B, MIT + Apache-2.0 (Qwen3.5/3.6 & Gemma 4 components)) |
...
MoziAI-35B-V3.8 basiert auf ornith-ai/Ornith-1.5-35B-A3B (Feinabstimmung/Destillation). Daten aus V3.7-Messungen (V3.8 = gleiche Basis und Trainingssystem):
