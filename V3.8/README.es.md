...
| Elemento | Parámetro |
| --- | --- |
| Modelo base | Ornith-1.5-35B-A3B (arquitectura Qwen3.5-35B-A3B / Qwen3.6-35B-A3B, licencia MIT + Apache-2.0 (Qwen3.5/3.6 & Gemma 4 components)) |
