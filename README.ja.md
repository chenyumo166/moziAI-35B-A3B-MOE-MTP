...
> 💡 **ダウンロードのヒン�?*: 上記リンクをクリックしてHuggingFaceリポジトリに移動し�?*「Files and versions�?*タブでV3.6ディレクトリ配下のすべてのファイルをダウンロードしてください（メインモデル、vision射影、チャットテンプレート）�?つのファイルすべてを同じディレクトリに配置してください�?
